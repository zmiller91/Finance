...
LOG_APP_PRINT = False
LOG_ERR_PRINT = False
LOG_STDIN = '/tmp/stdin.txt'
LOG_STDOUT = '/tmp/stdout.txt'
LOG_STDERR = '/tmp/stderr.txt'
...
DAEMON_SLEEP = 60
DAEMON_INSERT_DAILY = True
DAEMON_IS_DEBUG = False
# DAEMON_SLEEP = 0
# DAEMON_INSERT_DAILY = False
# DAEMON_IS_DEBUG = True